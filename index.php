...
<body class="front-page">
  <div class="mobile-menu">
    <ul class="mobile-menu-nav">
      <li class="mobile-menu-nav-item"><a href="#" class="mobile-menu-link">О компаний</a>
        <!-- /.header-nav-link --></li>
      <!-- /.header-nav-item -->
      ...
      <li class="mobile-menu-nav-item"><a href="#" class="mobile-menu-link">Собственные торговые марки</a>
        <!-- /.header-nav-link --></li>
      <!-- /.header-nav-item -->
      <li class="mobile-menu-nav-item"><a href="#" class="mobile-menu-link">Новости</a>
        <!-- /.header-nav-link --></li>
      <!-- /.header-nav-item -->
      <li class="mobile-menu-nav-item"><a href="#" class="mobile-menu-link">Контакты</a>
        <!-- /.header-nav-link --></li>
    </ul>
  ...
  <nav class="navbar">
    ...
    <ul class="header-nav">
      <li class="header-nav-item"><a href="./about.php" class="header-nav-link">О компаний</a>
        <!-- /.header-nav-link --></li>
      <!-- /.header-nav-item -->
      <li class="header-nav-item"><a href="#" class="header-nav-link">Контрактное производство</a>
        <!-- /.header-nav-link --></li>
      <!-- /.header-nav-item -->
      <li class="header-nav-item"><a href="#" class="header-nav-link">Собственные торговые марки</a>
        <!-- /.header-nav-link --></li>
      <!-- /.header-nav-item -->
      <li class="header-nav-item"><a href="#" class="header-nav-link">Новости</a>
        <!-- /.header-nav-link --></li>
      <!-- /.header-nav-item -->
      <li class="header-nav-item"><a href="#" class="header-nav-link">Контакты</a>
        <!-- /.header-nav-link --></li>
      <!-- /.header-nav-item -->
    </ul>
  ...
  <header class="header header-image">
   <div class="container">
    <div class="header-content">
      ...
      <button class="button heder-button" data-toggle="modal">Подробнее о компании</button>
    </div>
  ...
  <div class="container">
    ...
    <div class="cards">
      <a href="#" class="card">
       ...
       <!-- /.card-content -->
       <img src="img/avto1.png" alt="Автомобильная химия" class="card-image">
      </a>
    <a href="#" class="card">
       <div class="card-content">
      ...
      <!-- /.card-content -->
      <img src="img/slider 2.png" alt="Бытовая химия" class="card-image">
    </a>
    <a href="#" class="card">
      <div class="card-content">
      ...
      <!-- /.card-content -->
      <img src="img/slider 3.png" alt="Дезинфицирующие средства" class="card-image">
    </a>
    <a href="#" class="card">
      <div class="card-content">
      ...
      <!-- /.card-content -->
      <img src="img/slider 3.png" alt="Пищевые аэрозоли" class="card-image">
    </a>
    <a href="#" class="card">
      <div class="card-content">
      ...
      <!-- /.card-content -->
      <img src="img/avto1.png" alt="Косметическая продукция" class="card-image">
    </a>
    <a href="#" class="card">
     <div class="card-content">
     ...
     <!-- /.card-content -->
      <img src="img/slider 2.png" alt="Краски аэрозольные" class="card-image">
    </a></div>
    <!-- /.cards -->
  </div>
  <!-- /.container -->
...
<section class="section founder">
  ...
  <div class="container"> 
   <div class="fouder-content-wrapper">
      ...
      <div class="clients-wrapper">
          ...
          <ul class="clients-list">
            <li class="clients-list-item">
              <svg width="30" height="30" class="clients-list-icon">
                <use href="img/sprite.svg#xim"></use>
              </svg>
        ...
        <div class="clients-logo-list">
          <a href="#" class="clinets-logo-item">
            <img src="img/burger.png" alt="" class="clients-logo">
          </a>
          <a href="#" class="clinets-logo-item">
            <img src="img/burger.png" alt="" class="clients-logo">
          </a>       
